...
static Link rotateL (Link n2)
{
	...
	Link n1 = n2->right;   
	n2->within->root->within->nrotates = n2->within->root->within->nrotates+1; 
	if (n1 == NULL) return n2;
	n2->right = n1->left;
	n1->left = n2;
	n1->within->root->within->nrotates = n2->within->root->within->nrotates;
	return n1;
}
...
static Link rotateR (Link n1)
{
	...
	Link n2 = n1->left;
	n1->within->root->within->nrotates = n1->within->root->within->nrotates+1;
	if (n2 == NULL) return n1;
	n1->left = n2->right;
	n2->right = n1;
	n2->within->root->within->nrotates = n1->within->root->within->nrotates;
	return n2;
}
