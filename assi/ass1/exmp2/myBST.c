...
//insert Tfidf node into appropriate place
...
//find and return the node who contain given word
...
//delete duplicated nodes, node who contain same file name in a tfidflist
